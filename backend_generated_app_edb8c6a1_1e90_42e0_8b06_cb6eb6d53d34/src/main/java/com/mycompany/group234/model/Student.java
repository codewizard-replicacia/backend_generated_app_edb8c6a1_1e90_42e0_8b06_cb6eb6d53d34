...
public class Student {
  ...
  @Embedded
  @Column(name = "\"NoAdhaar\"")
  @AttributeOverrides({
            	@AttributeOverride(name = "personId", column = @Column(name = "\"NoAdhaar_PersonId\"")) ,
            	@AttributeOverride(name = "aadharNo", column = @Column(name = "\"NoAdhaar_AadharNo\""))  }) 
  private Person noAdhaar;
